...
<div id="pageAll">
    <div class="pageTop">
        <div class="page">
            <img src="{{URL::asset('')}}public/style/img/coin02.png" /><span><a href="{{url('index/index')}}">首页</a>&nbsp;-</span>&nbsp;企业管理
        </div>
    </div>
        ...
        <div class="connoisseur">
            <div class="conform">
                <form>
                    <div class="cfD">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="addUser" type="text"  name="rec_title" id="rec_title" placeholder="输入标题" value="{{$re->a}}" />
            ...
            <div class="conShow" id="list">
                <table border="1" cellspacing="0" cellpadding="0">
					...
					<input type="hidden" id="m_id" name="m_id" value="{{$val->m_id}}"  />
                    <tr height="40px">
                        <td>
                            <?php echo $val->rec_id?>
                        </td>
                        ...
                        <td><a href="{{url('Firm/recruit')}}?rec_id=<?=$val->rec_id?>" >查看</a></td>
                    </tr>
                    <?php }?>
                </table>
                <div class="paging">
