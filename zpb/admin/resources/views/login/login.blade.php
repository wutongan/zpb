...
<link rel="stylesheet" type="text/css" href="{{URL::asset('')}}public/style/css/style.css" />
<style>
body{height:100%;background:#16a085;overflow:hidden;}
canvas{z-index:-1;position:absolute;}
</style>
<script src="{{URL::asset('')}}public/style/js/jquery.js"></script>
<script src="{{URL::asset('')}}public/style/js/verificationNumbers.js"></script>
<script src="{{URL::asset('')}}public/style/js/Particleground.js"></script>
<script>
