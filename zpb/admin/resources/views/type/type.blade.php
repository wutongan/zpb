...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="{{URL::asset('')}}public/style/img/coin02.png" /><span><a href="{{url('index/index')}}">首页</a>-</span>&nbsp;添加职位
			</div>
		</div>
		...
		<div class="page">
			...
			<div class="connoisseur">
				<div class="conform">
					<form>
						<div class="cfD">
						<a class="addA addA1" href="{{url('Type/lists')}}">分类列表</a>
						</div>
					</form>	
				</div>
				<!-- 职位分类表单 -->
			...
			<div class="bacen">
				...
				<div class="bbD">
					<p class="bbDP">
						...
						<a class="btn_ok btn_no" href="{{url('Type/lists')}}" >取消</a>
					</p>
				</div>
			</div>
		</div>
