...
<head>
<script id="allmobilize" charset="utf-8" src="<?php echo e(URL::asset('')); ?>style/js/allmobilize.min.js"></script>
...
<script src="<?php echo e(URL::asset('')); ?>style/js/jquery.1.10.1.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('')); ?>style/js/jquery.lib.min.js"></script>
<script src="<?php echo e(URL::asset('')); ?>style/js/ajaxfileupload.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('')); ?>style/js/additional-methods.js"></script>
<!--[if lte IE 8]>
...
<script type="text/javascript" src="<?php echo e(URL::asset('')); ?>style/js/conv.js"></script>
</head>
<body>
<div id="body">
<div id="header">
...
<img src="<?php echo e(URL::asset('')); ?>style/images/logo.png" width="229" height="43" alt="拉勾招聘-专注互联网招聘" />
</a>
<ul class="reset" id="navheader">
<li class="current"><a href="<?php echo e(url('Index/index')); ?>">首页</a></li>
...
<ul class="loginTop">
<li><a href="<?php echo e(url('Index/login')); ?>" rel="nofollow">登录</a></li> 
<li>|</li>
<li><a href="<?php echo e(url('Index/register')); ?>" rel="nofollow">注册</a></li>
</ul>
</div>
</div><!-- end #header -->
<div id="container">
...
<script type="text/javascript" src="<?php echo e(URL::asset('')); ?>style/js/core.min.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('')); ?>style/js/popup.min.js"></script>
