...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="<?php echo e(URL::asset('')); ?>public/style/img/coin02.png" /><span><a href="<?php echo e(url('index/index')); ?>">首页</a>&nbsp;-&nbsp;-</span>&nbsp;职位列表
			</div>
		</div>
		...
		<!-- user页面样式 -->
			<div class="connoisseur">
				<div class="conform">
					<form>
						<div class="cfD">
							<input class="userinput" type="text"  placeholder="输入关键字" value="<?php echo e($arr->a); ?>" id="sou"/>
							<input type="button" class="userbtn" id="button" value="搜索" >
							<a class="addA addA1" href="<?php echo e(url('Type/type')); ?>">添加分类</a>
						</div>
					</form>
				</div>
				<!-- user 表格 显示 -->
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" id="ad">
						...
						<tr height="40px">
							...
							<td><?php echo e($v->pid_name); ?></td>
							<td><?php echo e(date('Y-m-d H:i:s',$v->type_add_time)); ?></td>
							<td>
							<a href="del_type?id=<?php echo e($v->type_id); ?>">删除</a>
							</td>
						</tr>
						<?php endforeach; ?>
					</table>
					<div class="paging"><?php echo e($arr->render()); ?></div>
				</div>
				<!-- user 表格 显示 end-->
			</div>
			<!-- user页面样式end -->
...
$('#button').click(function(){
	var zhi = $('#sou').val();
	var data={'zhi':zhi};
	var url="<?php echo e(url('Type/lists')); ?>";
