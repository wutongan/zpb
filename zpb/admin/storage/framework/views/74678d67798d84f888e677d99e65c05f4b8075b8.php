...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="<?php echo e(URL::asset('')); ?>public/style/img/coin02.png" /><span><a href="<?php echo e(url('index/index')); ?>">首页</a>&nbsp;-&nbsp;<a
					href="<?php echo e(url('System/changepwd')); ?>">系统管理</a>&nbsp;-</span>&nbsp;修改密码
			</div>
		</div>
		<div class="page ">
			<!-- 修改密码页面样式 -->
			<div class="bacen">
				<div class="bbD">
					<input type="hidden" id="id" value="<?php echo e($arr->adm_id); ?>" >
				</div>
				<div class="bbD">管理员用户名：&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($arr->adm_user); ?>

				</div>
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						onblur="checkpwd1()" id="pwd1" /> <img class="imga"
						src="<?php echo e(URL::asset('')); ?>public/style/img/ok.png" /><img class="imgb" src="<?php echo e(URL::asset('')); ?>public/style/img/no.png" />
				</div>
				<div class="bbD">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" onblur="checkpwd3()"
						id="pwd3" /> <img class="imga" src="<?php echo e(URL::asset('')); ?>public/style/img/ok.png" /><img
						class="imgb" src="<?php echo e(URL::asset('')); ?>public/style/img/no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
...
var user = document.getElementById('pwd1').value.trim();
 if (user.length >= 1 && user.length <= 12) {
  ...
  $.ajax({
	  type:'post',
	  url:"<?php echo e(url('System/getpwd')); ?>",
	  data:'id='+id+'&pwd='+pwd,
	  success:function(e)
	  {
		  if(e==1)
