			...
			<div class="bacen">
				...
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						...
						src="<?php echo e(URL::asset('')); ?>style/img/ok.png" /><img class="imgb" src="<?php echo e(URL::asset('')); ?>style/img/no.png" />
				</div>
				<div class="bbD">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" onblur="checkpwd3()"
						id="pwd3" /> <img class="imga" src="<?php echo e(URL::asset('')); ?>style/img/ok.png" /><img
						class="imgb" src="<?php echo e(URL::asset('')); ?>style/img/no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
