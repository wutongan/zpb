...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
                <img src="<?php echo e(URL::asset('')); ?>public/style/img/coin02.png" /><span><a href="<?php echo e(url('Index/right')); ?>">首页</a>&nbsp;-&nbsp;<a href="<?php echo e(url('Search/search')); ?>">热词管理</a>&nbsp;-</span>&nbsp;热词列表
			</div>
		</div>
		...
		<div class="page">
			...
			<div class="connoisseur">
				<div class="conform">
						<div class="cfD">
							<input class="userinput" type="text" placeholder="输入关键字" value="<?php echo e($list->search); ?>" />
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr height="40px" id="<?php echo e($v->sea_id); ?>">
							<td><?php echo e($v->sea_id); ?></td>
							<td><?php echo e($v->sea_name); ?></td>
							<td><?php echo e($v->sea_num); ?></td>
							<td>
								<a href="<?php echo e(url('Search/update')); ?>?id=<?php echo e($v->sea_id); ?>" class="aColor">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="javascript:;" id="<?php echo e($v->sea_id); ?>" class="aColor1">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
                        <?php endforeach; ?>
					</table>
...
$(".userbtn").click(function(){
    ...
    $.get("<?php echo e('search'); ?>",{userinput:userinput},function(msg){
    ...
    $.get("delete",{id:id,last_id:last_id},function(msg){
        if(msg==1){
            ...
            for(var i=0;i<data.length;i++){
                ...
                str+="<td>";
                str+="<a href=\"+<?php echo e(url('Search/update')); ?>?id='"+data[i].sea_id+"' class='aColor'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;";
