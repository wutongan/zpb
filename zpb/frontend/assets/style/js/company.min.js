$(function() {
    var a, b, c, d;
    $(".tipExpire .expire_close").bind("click",
    function() {
        var a = $.cookie("showExpriedCompanyHome");
        $.cookie("showExpriedCompanyHome", a - 1),
    ...
    $("#saveLabels").click(function() {
		...
		($("#addLabels").hide(), $(".c_box h3").hide(), $("#hasLabels li").each(function() {
			$(this).find("i").remove()
		}), $("#hasLabels").on("mouseenter", "li",
		function() {
			$(this).css({
		...
		}), $("#hasLabels").append('<li class="link">编辑</li>'), a = $("#hasLabels").html(), c.parents(".c_detail").removeClass("c_detail_bg"));
    }),
    $("#hasLabels").on("click", ".link",
    function() {
    ...
    $("#hasLabels").on("click", "li i",
    function() {
		var b = $(this);
		var a = b.siblings().html();
		$.ajax({
			type:'get',
			url:'index.php?r=create/del_firm_xy',
			data:'a='+a,
    ...
    function() {
        ...
        }), c ? $.ajax({type:'get',url:'index.php?r=create/label',data:'b='+b,success:function(msg){if(msg==1){$("#hasLabels").append("<li><span>" + b + "</span><i>x</i></li>")}}}) : alert("此标签已存在，请重新输入"), a.val("")) : alert("请输入1-6字的自定义标签")
    }),
    ...
    function() {
        ...
        $(".memberForm", a).validate({
            ...
            submitHandler: function(b) {
                ...
                "" != h && "http://" != h.substring(0, 7) && (h = "http://" + h),
                i = "请输入创始人个人简介" != $('textarea[name="remark"]', b).val() ? $('textarea[name="remark"]', b).val() : "",
                j = $("#resubmitToken").val(),
                a = $(b).parents(".member_wrap"),
                ...
                $.ajax({
                    ...
                    $("#resubmitToken").val(c.resubmitToken),
    ...
    $("#Member .memberForm").on("keyup", ".s_textarea",
    function() {
        var a = $(this),
        b = $.trim(a.val()).length;
    ...
    $(".memberForm").each(function() {
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                "" != g && "http://" != g.substring(0, 7) && (g = "http://" + g),
                h = "请输入创始人个人简介" != $('textarea[name="remark"]', a).val() ? $('textarea[name="remark"]', a).val() : "",
                i = $(a).parents(".member_wrap"),
                j = $("#resubmitToken").val(),
                ...
                $.ajax({
                    ...
                    b.success ? ($(".member_info:nth-child(1)", i).addClass("dn"), $(".member_info:nth-child(2)", i).addClass("dn"), $(".member_info:nth-child(2) .leader_id", i).val(b.content.id), $(".member_info:nth-child(3) img", i).attr("src", ctx + "/" + b.content.photo), "" != b.content.weibo ? $(".member_info:nth-child(3) .m_name", i).html(b.content.name + '<a href="' + b.content.weibo + '" class="weibo" target="_blank"></a>') : $(".member_info:nth-child(3) .m_name", i).html(b.content.name), $(".member_info:nth-child(3) .m_position", i).html(b.content.position), $(".member_info:nth-child(3) .m_intro", i).html(b.content.remark), $(".member_info:nth-child(3)", i).removeClass("dn"), $("#Member .member_wrap").length >= 3 ? $("#Member .c_add").hide() : $("#Member .c_add").show()) : 1 == $(".member_wrap").length ? ($(".member_info:nth-child(1)", i).removeClass("dn"), $(".member_info:nth-child(2)", i).addClass("dn"), $(".member_info:nth-child(2) input[type!='submit'], .member_info:nth-child(2) textarea", i).val(""), $(".member_info:nth-child(3)", i).addClass("dn"), $("#Member .c_add").hide()) : ($(i).remove(), $("#Member .c_add").show()),
                    $(a).find(":submit").attr("disabled", !1)
                })
            }
        })
    }),
    $("#Product").on("click", ".product_add",
    function() {
        ...
        $("#Product .product_wrap").length >= 3 && $(".product_add").addClass("dn"),
        $(".productForm", a).validate({
            ...
            submitHandler: function(b) {
                ...
                "" != g && "http://" != g.substring(0, 7) && (g = "http://" + g),
                h = "请简短描述该产品定位、产品特色、用户群体等" != $('textarea[name="productProfile"]', b).val() ? $('textarea[name="productProfile"]', b).val() : "",
                i = $("#resubmitToken").val(),
                a = $(b).parents(".product_wrap"),
                $(b).find(":submit").attr("disabled", !0),
                $.ajax({
                    type: "POST",
    ...
    $("#Product").on("click", ".product_delete",
    function() {
        var a, b;
    ...
    $("#Product .productForm").on("keyup", ".s_textarea",
    function() {
        var a = $(this),
        b = $.trim(a.val()).length;
        b > 500 ? a.val(a.val().substring(0, 500)) : $(this).siblings("span").length > 0 && (b > 10 || 10 == b) ? $(this).siblings("span").hide() : $(this).siblings("span").length > 0 && 10 > b ? $(this).siblings("span").show() : a.next(".word_count").children("span").text(500 - b)
    ...
    $(".productForm").each(function() {
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                "" != f && "http://" != f.substring(0, 7) && (f = "http://" + f),
                g = "请分段详细描述公司简介、企业文化等" != $('textarea[name="productProfile"]', a).val() ? $('textarea[name="productProfile"]', a).val() : "",
                h = $("#resubmitToken").val(),
                i = $(a).parents(".product_wrap"),
                $(a).find(":submit").attr("disabled", !0),
                $.ajax({
                    type: "POST",
                    url: ctx + "/cp/saveCompanyProduct.json",
                    ...
                    $("#resubmitToken").val(b.resubmitToken),
                    b.success ? ($("dl:nth-child(1)", i).addClass("dn"), $("dl:nth-child(2)", i).addClass("dn"), $("dl:nth-child(2) .product_id", i).val(b.content.id), $("dl:nth-child(3) img", i).attr("src", ctx + "/" + b.content.productPicUrl), $("dl:nth-child(3) .cp_intro a", i).attr("href", b.content.productUrl), $("dl:nth-child(3) .cp_intro a", i).html(b.content.product), $("dl:nth-child(3) .jspPane > div", i).html(b.content.productProfile), $("dl:nth-child(2) textarea", i).text(b.content.productProfile), $("dl:nth-child(3)", i).removeClass("dn"), $(".scroll-pane").jScrollPane()) : 1 == $(".product_wrap").length ? ($("dl:nth-child(1)", i).removeClass("dn"), $("dl:nth-child(2)", i).addClass("dn"), $("dl:nth-child(2) input[type!='submit'], dl:nth-child(2) textarea", i).val(""), $("dl:nth-child(2) textarea", i).text(""), $("dl:nth-child(3)", i).addClass("dn")) : $(i).remove(),
                    $(a).find(":submit").attr("disabled", !1)
                })
            }
        })
    ...
    $("#companyDesForm").submit(function() {
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                if (b.success) if ("" == b.content) $("dl:nth-child(1)", d).show(),
                $("dl:nth-child(2) textarea", d).val(""),
                $("dl:nth-child(2)", d).hide(),
                $("dl:nth-child(3) .c_intro", d).html(""),
                $("dl:nth-child(3)", d).hide();
                else {
                    $("dl:nth-child(1)", d).hide();
                    var c = b.content;
                    c && (c = $.trim(c.replace(/<br \/>/gi, ""))),
                    $("dl:nth-child(2) textarea", d).val(c),
                    $("dl:nth-child(2)", d).hide(),
                    $("dl:nth-child(3) .c_intro", d).html(b.content),
                    $("dl:nth-child(3)", d).show()
                } else alert("保存失败");
                $(a).find(":submit").attr("disabled", !1)
            })
        }
    }),
    $("#companyProfile").bind("keyup",
    function() {
        var a = $(this),
        b = $.trim(a.val()).length;
    ...
    $("#box_sca").on("click", "ul li",
    function(a) {
        a.stopPropagation();
        var b = $(this).text();
        $("#select_sca").val(b).removeClass("select_tags_focus"),
        $("#companySize").val(b),
        $("#box_sca").hide()
    }),
    $("#box_fin,#box_sca").bind("click",
    function(a) {
        a.stopPropagation()
    }),
    ...
    $(".c_stages .c_edit").bind("click",
    function() {
        $(this).hide(),
        $(".c_stages .stageshow").hide(),
        c = $(".c_stages #stageform").clone(),
        $(".c_stages #stageform").show(),
        $("#box_sca").hide()
    }),
    $(".c_stages").on("click", ".select_invest",
    function(a) {
        a.stopPropagation(),
        $("#box_sca").hide(),
    ...
    $(".c_stages").on("click", ".selectBoxShort li",
    function(a) {
        var b, c;
        a.stopPropagation(),
        b = $(this).html(),
    ...
    $(".c_stages #stageform").validate({
        ...
        submitHandler: function(a) {
            ...
            $("#stagesList > li").each(function(a) {
                d = $(this).children('input[name="select_invest_hidden"]').val(),
                e = $(this).children('input[name="stageorg"]').val() != $(this).children('input[name="stageorg"]').attr("placeholder") ? $(this).children('input[name="stageorg"]').val() : "",
                c += a == $("#stagesList > li").length - 1 ? '{"stage":"' + d + '","org":"' + e + '"}': '{"stage":"' + d + '","org":"' + e + '"},'
            }),
            c += "]",
            f = $("#resubmitToken").val(),
            $(a).find(":submit").attr("disabled", !0),
    ...
    d = {
        ...
        addReport: function() {
            ...
            this.obj.find("ul.reset").append(a).removeClass("dn"),
            $(".reportForm", a).validate({
                onkeyup: !1,
                focusCleanup: !0,
                rules: {
                    articleTitle: {
                ...
                submitHandler: function(a) {
                    ...
                    $.ajax({
                        ...
                        var c, d, e;
                        $("#resubmitToken").val(b.resubmitToken),
                        b.success ? (c = b.content, d = "", e = "", e = "http://" != c.url.substring(0, 7) ? "http://" + c.url: c.url, d = c.title, $(a).siblings("a.article").html(d).attr({
                            href: e,
                            title: c.title
                        }), $(".article_id", a).val(c.id), $(a).addClass("dn").siblings("a").show(), $(a).children(".btn_cancel_s").addClass("report_delete").removeClass("report_cancel").text("删除")) : console.log(b.msg),
                        $(a).find(":submit").attr("disabled", !1)
                    })
                }
            })
        ...
        editReport: function(a) {
            ...
            a.siblings("form").children("input").eq(0).val(b),
            a.siblings("form").children("input").eq(1).val(c),
            a.hide().siblings("a").hide().siblings("form").removeClass("dn")
        },
    ...
    $("#Reported .c_reported .c_add").bind("click",
    function() {
    ...
    $("#Reported .c_reported .report_edit").bind("click",
    function() {
        $(this).parent(".reported_info").addClass("dn"),
        $("#Reported .c_reported .c_add").removeClass("dn"),
        d.addReport()
    }),
    $("#Reported").on("click", "ul .c_edit",
    function() {
        d.editReport($(this))
    }),
    $("#Reported").on("click", "ul .report_delete",
    function() {
        confirm("确定要删除此条报道吗？") && d.delReport($(this))
    }),
    $("#Reported").on("click", "ul .report_cancel",
    function() {
        $(this).parent("form").parent("li").remove(),
        0 == d.obj.find("ul.reset").children("li").length ? (d.obj.find(".c_add").addClass("dn"), d.obj.find("ul.reset").addClass("dn").siblings(".reported_info").removeClass("dn")) : d.obj.find(".c_add").removeClass("dn")
    }),
        ...
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    var c, d, e;
                    $("#resubmitToken").val(b.resubmitToken),
                    b.success ? (c = b.content, d = "", e = "", e = -1 != c.url.indexOf("http://") || -1 != c.url.indexOf("https://") ? c.url: "http://" + c.url, d = c.title, $(a).siblings("a.article").html(d).attr({
                        href: e,
                        title: c.title
                    }), $(".article_id", a).val(c.id), $(a).addClass("dn").siblings("a").show()) : console.log(b.msg),
                    $(a).find(":submit").attr("disabled", !1)
                })
            }
        })
