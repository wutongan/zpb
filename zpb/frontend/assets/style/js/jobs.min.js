...
$(function() {
    ...
    "请输入有效的公司所在城市，如：北京"),
    jQuery.validator.addMethod("hasEmail",
    function(a) {
    ...
    jQuery.validator.addMethod("forwardEmailFormat",
    function(a) {
    ...
    jQuery.validator.addMethod("forwardSame",
    function(a) {
        var d = $.trim(a),
    ...
    $("#jobPreview").click(function() {
        $("#jobForm").attr({
            action: ctx + "index.php?r=create/preview",
            target: "_blank"
        }).submit()
    }),
