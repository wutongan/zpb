                        ...
                        $(a).find(":submit").val("保存中...").attr("disabled", !0),
                            $.ajax({
                                ...
                                if ($("#resubmitToken").val(b.resubmitToken), b.success) {
                                    for (d = b.content.workExperiences, e = "", f = 0; f < d.length; f++) e += 0 == f % 2 ? '<li data-id="' + d[f].id + '" class="clear">': '<li data-id="' + d[f].id + '">',
