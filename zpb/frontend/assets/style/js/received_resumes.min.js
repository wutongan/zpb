...
function highlight() {
    ...
    $("#filterForm ul.resumeLists").prepend('<li class="borderHighlight"></li>'),
        $("#filterForm ul.resumeLists li.borderHighlight").css("height", a).fadeIn(400).delay(2500).fadeOut(400)
}
$(function() {
    $("#filter_btn").bind("click",
        function() {
        ...
        $(".resumeLists .checkbox input").bind("click",
            function() {
            ...
            function() {
                ...
                $('#refuseMailForm input[name="deliverId"]').val(a),
                    $.ajax({
                        ...
                        a.success && ($("#refuseMailForm textarea").val(a.content.content).removeClass("error").removeClass("valid"), $("#refuseMailForm span.error").remove()),
                            $.colorbox({
                                inline: !0,
                                href: $("#confirmRefuse"),
                                title: "确认简历不合适"
        ...
        $("#resumeRefuseAll").click(function() {
            ...
            return $(".resumeLists li").each(function() {
                ...
                a = a.join(","),
                "" == a ? (alert("请选择要标记的简历"), !1) : confirm("确定要标记选中的简历为不合适简历吗？确认后系统将自动发送拒绝信至用户邮箱") ? ($.ajax({
                    type: "POST",
                    url: ctx + "/corpResume/markRefuse.json",
                    data: {
                        deliverIds: a,
        ...
        $("#resumeInterviewAll").click(function() {
            ...
            return $(".resumeLists li").each(function() {
                ...
                a = a.join(","),
                "" == a ? (alert("请选择要标记的简历"), !1) : confirm("确定要标记选中的简历为待定简历吗？") ? ($.ajax({
                    type: "POST",
                    url: ctx + "/corpResume/markInterview.json",
                    data: {
                        deliverIds: a,
        ...
        //    function() {
                ...
                //    d = "（简历来自拉勾）" + $(this).attr("data-positionName") + "：" + $(this).attr("data-resumeName"),
                //    e = "以下是应聘“" + $(this).attr("data-positionName") + "”的简历。我已查阅，请您评估一下。 若觉合适，我们将安排面试，谢谢！",
                ...
                //    $('#forwardResumeForm input[name="title"]').val(d).removeClass("error").removeClass("valid"),
                //    $('#forwardResumeForm textarea[name="content"]').val(e).removeClass("error").removeClass("valid"),
        ...
        $(".resumeLists li a.resumeImg").bind("click",
            function() {
                $(this).siblings(".resumeIntro").children("h3").removeClass("unread").addClass("read")
            }),
        $(".resumeLists li h3.unread a").bind("click",
            function() {
        ...
        $(".resumeLists a.resume_forward").on("click", "dl",
            function() {
                return ! 1
            })
});